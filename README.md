...
struct CATransform3D
{
 ...
 要实现 View（Layer） 的透视效果(近大远小)，通过设置 m34 
...
* m34 = -1/z中，当z为正的时候，是我们人眼观察现实世界的效果，即在投影平面上表现出近大远小的效果，z越靠近原点则这种效果越明显，越远离原点则越来越不明显，当z为正无穷大的时候，则失去了近大远小的效果，此时投影线垂直于投影平面，也就是视点在无穷远处，


distance （z值） |  效果
------------- | -------------
0.1...500  | Very close, lots of perspective distortion.（非常接近，大量透视变形的。）
750...2,000  | Nice perspective, content is clearly visible（好的角度，内容清晰）
2,000 and up  | Almost no perspective distortion.（几乎没有透视变形。）
...
旋转 3D 动画代码：
 ...
 上述代码使用后，会得到旋转后的结果，但是，会有一个锯齿的问题，我们可以通过如下代码，解决这个边缘锯齿的问题：
  ...
  * 3D旋转有一个锚点的旋转设置：layer.anchorPoint ，通过设置这一锚点值，设置旋转是以什么为中心进行变换，默认值是 （0.5，0.5），即，中心位置。
